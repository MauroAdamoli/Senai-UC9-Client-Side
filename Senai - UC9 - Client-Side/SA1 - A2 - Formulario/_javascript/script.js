    ...
    var verify_form = () => {
        ...
        if( validos()==false)
        {
          ...
          var campo_ano = document.getElementById("year");
              ...
              var campo_disp_8 = document.getElementById("sport_8").checked;
              if (campo_disp_8)
                obj_form.sport.push(8);

              var campo_disp_9 = document.getElementById("sport_9").checked;
              if (campo_disp_9)
                obj_form.sport_9.push(9);

              var campo_disp_10 = document.getElementById("sport_10").checked;
              if (campo_disp_10)
                obj_form.sport_10.push(10);
